...
const nextConfig = {
   ...
   */
  basePath: process.env.NODE_ENV === 'production' ? '/zkex' : '', // update if your repo name changes for 'npm run deploy' to work successfully
  assetPrefix: process.env.NODE_ENV === 'production' ? '/zkex/' : '', // update if your repo name changes for 'npm run deploy' to work successfully
};
